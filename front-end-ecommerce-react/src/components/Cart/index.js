                            ...
                            {cart.Cart.map( item =>{
                                return(
                                    <tr key={item.id}>
                                        ...
                                        <th><span className="badge badge-pill bg-secondary">
                                            {item.quantity}
                                        </span></th>
                                        <th>R$ {item.price.toFixed(2)}</th>
                                        <th><button onClick={()=>dispatch(cartActions.AddItem(cart, item))} className="badge badge-pill" style={{color:"gray"}}><i className="fas fa-plus"></i></button></th>
                                        <th><button onClick={()=>dispatch(cartActions.RemoveItem(cart, item))} className="badge badge-pill" style={{color:"gray"}}><i className="fas fa-minus"></i></button></th>
